...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>UserInfo/frontlist">学生信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>UserInfo/userInfo_frontAdd.jsp" style="display:none;">添加学生</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<userInfoList.size();i++) {
            		...
            		UserInfo userInfo = userInfoList.get(i); //获取到学生对象
            		String clearLeft = "";
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>UserInfo/<%=userInfo.getUser_name() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=userInfo.getUserPhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		所在学院:<%=userInfo.getColleageObj().getColleageName() %>
			     	</div>
			     	<div class="field">
	            		姓名:<%=userInfo.getName() %>
			     	</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_colleageObj_collleageId_edit" class="col-md-3 text-right">所在学院:</label>
		  	 <div class="col-md-9">
			    <select id="userInfo_colleageObj_collleageId_edit" name="userInfo.colleageObj.collleageId" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
			...
			if (userInfo) {
				...
				$.ajax({
					...
					success: function(colleages,response,status) { 
						$("#userInfo_colleageObj_collleageId_edit").empty();
						var html="";
		        		$(colleages).each(function(i,colleage){
		        			html += "<option value='" + colleage.collleageId + "'>" + colleage.colleageName + "</option>";
		        		});
		        		$("#userInfo_colleageObj_collleageId_edit").html(html);
		        		$("#userInfo_colleageObj_collleageId_edit").val(userInfo.colleageObjPri);
					}
				});
