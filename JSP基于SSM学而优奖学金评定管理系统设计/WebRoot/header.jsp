...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">奖学金评定网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!--<li><a href="<%=basePath %>UserInfo/frontlist">学生</a></li>
                <li><a href="<%=basePath %>Colleage/frontlist">学院</a></li>
                <li><a href="<%=basePath %>Fdy/frontlist">辅导员</a></li>
                <li><a href="<%=basePath %>TermInfo/frontlist">学期</a></li>
                -->
                <li><a href="<%=basePath %>JxjType/frontlist">奖学金类型查询</a></li> 
                <li><a href="<%=basePath %>Jxj/frontlist">奖学金申请查询</a></li>
                <li><a href="<%=basePath %>Score/frontlist">学生成绩查询</a></li>
                <li><a href="<%=basePath %>Family/frontlist">家庭情况查询</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Jxj/jxj_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;申请奖学金</a></li>
                        <li><a href="<%=basePath %>Jxj/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我申请的奖学金</a></li>
                        <li><a href="<%=basePath %>Score/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的成绩查询</a></li>
                        <li><a href="<%=basePath %>Family/family_frontUserAdd.jsp"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;登记家庭情况</a></li>
                        <li><a href="<%=basePath %>Family/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的家庭情况查询</a></li>
